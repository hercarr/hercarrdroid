...
public class ImageInputUtils {
    ...
    public ImageInputUtils(Activity mContext) {
        this.mContext = mContext;
    }

    public ImageInputUtils(Fragment fragment) {
    ...
    public void takePhotoWithCamera() {
        ...
        if (tempFileFromSource == null) {
            try {
                tempFileFromSource = File.createTempFile("choose", "png", mContext.getExternalCacheDir());
                if (tempFileFromSource == null) {
                    tempFileFromSource = File.createTempFile("choose", "png", mContext.getCacheDir());
                }
                tempUriFromSource = Uri.fromFile(tempFileFromSource);
            } catch (IOException e) {
                e.printStackTrace();
